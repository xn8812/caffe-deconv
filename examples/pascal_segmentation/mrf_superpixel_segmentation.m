...
imDir = 'examples/pascal_segmentation/VOCdevkit/VOC2011/JPEGImages/';
...
clfDir = 'examples/pascal_segmentation/VOCdevkit/local/VOC2011/';
NC = 21;
...
% clfmodel = load([clfDir 'pascal_suerpixel_classification_2_iter0030.mat']);
clfmodel = load([clfDir 'pascal_suerpixel_classification_2_large_iter0003.mat']);
...
% load cooc for inference
stat = load('examples/pascal_segmentation/cooc_stat.mat');
cooc = stat.cooc_local_normalized;
labelcost = -log(cooc);

% start inference
valSet = textread('examples/pascal_segmentation/VOCdevkit/VOC2011/ImageSets/Segmentation/val.txt','%s');
predDir = 'examples/pascal_segmentation/VOCdevkit/results/VOC2011/Segmentation/comp5_val_cls/';
